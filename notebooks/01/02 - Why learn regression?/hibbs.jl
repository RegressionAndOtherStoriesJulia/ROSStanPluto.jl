...
let
	f = open("/Users/rob/.julia/dev/ROSStanPluto/data/Hibbs/hibbs.csv", "w")
	CSV.write(f, hibbs)
	close(f)
end
...
let
	...
	let
		plt = data(post1_1s_df) * mapping(:sigma; color=:chain) * density()
...
let
	...
	ax = Axis(fig[1, 2]; title="Posterior draws", 
		xlabel, ylabel, ylims=(40, 65))
...
# ╔═╡ 77894ca3-0f8c-4b51-9ba5-8a3623d37886
mad(post1_1s.a)

# ╔═╡ 2baad6fe-1e75-4f2c-963c-2e1fad770042
std(post1_1s.a)

# ╔═╡ a1edc3cf-ea45-4c1b-b6c6-7a35bd0ba6b6
median(post1_1s.b)

# ╔═╡ b01d25ee-04d3-4c8d-9276-052a1b6f5ee0
mad(post1_1s.b)

# ╔═╡ 0cc5c66c-af12-46d8-a53f-2abdeb1d481e
std(post1_1s.b)

# ╔═╡ 71adb370-6670-4068-82a3-8caf6ab98f12
median(post1_1s.sigma)

# ╔═╡ 5b83cb0f-0b1b-4dc2-9790-fa87cb5f2d20
mad(post1_1s.sigma)
...
[mean(nt.x), median(nt.x), std(nt.x), mad(nt.x)]
...
julia_version = "1.8.0-DEV.1483"
manifest_format = "2.0"
project_hash = "ee9c3c52a8639d0e491bf4d69ff748173d230932"
...
git-tree-sha1 = "f2cce6020c876f99bd85beece9693d236d4c4bce"
...
git-tree-sha1 = "b91520468425b000d650e97b49e02d7231187de0"
...
git-tree-sha1 = "39f41092140f3bae23350dcec35973f6606959b2"
