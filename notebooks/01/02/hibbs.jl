...
begin
	...
	a_mean = sdf[sdf.parameters .== :a, :mean][1]
	b_mean = sdf[sdf.parameters .== :b, :mean][1]
	plot!(x, a_mean .+ b_mean * x; lab="Regression line")
	annotate!(4, 55, 
		("y = $(round(a_mean; digits=1)) + $(round(b_mean; digits=1)) * x",
			10, :darkblue))
end
...
# ╔═╡ f2299a02-a256-4ec0-a5f3-c2834a476d21
mad_sd(x::Vector{Float64}) = median(abs.(x .- median(x)))

# ╔═╡ 4b9eefca-7968-48f6-a2ba-61713307c3f1
mad_sd(post1_1s.a)

# ╔═╡ 405c7c18-0af1-4177-9327-74b13064bacd
mad_sd(post1_1s.b)

# ╔═╡ 4277aaf4-de9c-46ca-a4e1-b4acb806718a
mad_sd(post1_1s.sigma)
