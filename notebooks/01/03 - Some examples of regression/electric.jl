...
begin
	electric = CSV.read(ros_data("ElectricCompany", "electric.csv"),
		DataFrame)
...
let
	...
	plt = el * density() * mapping(row=:treatment)
	draw!(f[1, 1], plt; axis)
	f
end	
...
let
	...
	plt = el * density() * mapping(color=:treatment)
	draw!(f[1, 1], plt)
	f
end	
...
manifest_format = "2.0"
project_hash = "c1b1d439f74136d95f04b6ed3d660f4df2dde411"
