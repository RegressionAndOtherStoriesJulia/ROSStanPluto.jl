...
let
	...
	sca1 = scatter!(x, y)
	annotations!("Slope of fitted line = $(round(means[3], digits=2))",
		position = (2.8, 10), textsize=15)
	lin1 = lines!(x1, means[1] .+ means[3] * x1)

	x2 = 0.0:0.01:1.0
	ax = Axis(f[2, 1], title="Regression with binary treatment",
		xlabel = "Treatment", ylabel = "Outcome")
	sca1 = scatter!(x_binary, y)
	lin1 = lines!(x2, means[2] .+ means[4] * x2)
	annotations!("Slope of fitted line = $(round(means[4], digits=2))", 
...
manifest_format = "2.0"
project_hash = "d5639d8f6feac829571f85ad091b25922bd23532"
