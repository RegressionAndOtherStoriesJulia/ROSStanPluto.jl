...
For access to locally stored date, use `ros_local_data()`.

This will become part of RegressionAndOtherStories.jl."
...
begin
	...
	ros_data(dataset, parts...) = normpath(joinpath(src_path, dataset, "data", parts...))
...
if success(rc2_1s)
	hdi2_1s = read_samples(m2_1s, :dataframe)
	#pretty_table(HTML, hdi2_1s)
end

# ╔═╡ 9cf379d5-aac4-4350-8a3f-99ad0000969a
ā, b̄, σ = mean(Array(hdi2_1s); dims=1)
...
# ╔═╡ 99007829-a51b-4834-ab4e-aad4fdf7ff88
versioninfo()

# ╔═╡ 0daa3336-9d7c-4d90-a4b3-a36a4208af2d
Pkg.status()
...
manifest_format = "2.0"
project_hash = "2d13774bbcadf49435d3982fc9dd45217cc58fb4"
