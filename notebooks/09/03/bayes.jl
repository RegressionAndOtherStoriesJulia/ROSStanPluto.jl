...
begin
	x = 0.3:0.001:0.7
	plot(; xlim=(0.3, 0.7), title="Prior, likelihood & posterior")
	plot!(x, pdf(Normal(theta_hat_prior, se_prior), x), col=:gray, 
		lab="prior")
	plot!(x, pdf(Normal(theta_hat_data, se_data), x), col=:darkred, 
		lab="Likelihood")
	plot!(x, pdf(Normal(theta_hat_bayes, se_bayes), x), col=:darkblue,
		lab="Posterior")
end
...
begin
	plot(; xlim=(0.3, 0.7), 
		title="Prior, likelihood & posterior (using `density()`)")
...
julia_version = "1.8.0-DEV.1437"
manifest_format = "2.0"
project_hash = "d3f5f3be89c35ce710930ead35ece33d2e24927d"
