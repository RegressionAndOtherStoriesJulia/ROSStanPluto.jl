...
# ╔═╡ 30764266-7021-4fab-bfbd-4d4c4699b8c2
...
# ╔═╡ b371d78f-9c8a-46b4-9bbf-3bc2dbcfda1c
@assert success(rc)

# ╔═╡ 081796ec-93af-43ae-9618-fdadf23ac4f1
options = (include_log_likelihood=true, include_sample_stats=true, include_posterior_predictive=true);

# ╔═╡ d9b44dd0-26c7-493e-beb2-9680f624d9ec
md" #### Groups defined:"

# ╔═╡ 3a45dcc8-6e0f-4b7d-affe-a46e9250fe96
idata = inferencedata(m_schools; options...)

# ╔═╡ 150f9cea-91da-4648-8469-dfb4c852227a
md" ##### To see more details, click on triangles above or specify group as shown below."

# ╔═╡ 1e5005ae-d02d-45d3-84ea-871ea4c58a28
md" ##### Posterior:"

# ╔═╡ 504ddf21-231d-404a-b693-717e0a61ef2d
idata

# ╔═╡ 245125b3-c4bf-404d-8796-bc72f28807ca
md" ##### Posterior:"

# ╔═╡ 86932216-da1a-47b5-b0d3-3a4fef8ae6bf
idata.posterior

# ╔═╡ c42f371c-30be-4eb7-a036-6ea4e49a7b53
md" ##### Posterior predictive:"

# ╔═╡ 8d2aef1a-8ddb-4ced-aca2-7a2a268dfb58
if options.include_posterior_predictive
    idata.posterior_predictive
end

# ╔═╡ 92c92285-5a8f-4c37-ada9-6aa9af7169ef
md" ##### Log-likelihood:"

# ╔═╡ 80f91c2f-4ac9-4dea-8237-6082d1cbb376
if options.include_log_likelihood
    idata.log_likelihood
end

# ╔═╡ bbb09396-bae9-4a5e-b3c4-bb2ffd0a7a8f
md" ##### Sample stats:"

# ╔═╡ 48f7f1b8-fee9-4a91-ac77-fb787ba6a839
if options.include_sample_stats
    idata.sample_stats
end

# ╔═╡ 83fd94d1-c65f-4154-be92-da19a099ed13
md" ##### Warmup sample stats:"

# ╔═╡ bd2dd108-38e4-4ff2-a4b9-1441e89baa97
...
manifest_format = "2.0"
project_hash = "c1b315563b11427578e49dc59223b5206406a5df"
...
git-tree-sha1 = "43f67c13e30ed6ec2b350a5812ed4478cac46375"
...
git-tree-sha1 = "aab1c800a19079f2ced90b610f0d369e155c32f7"
...
git-tree-sha1 = "eca2a4842c83d2e56cb55757faf95f81497d88ac"
