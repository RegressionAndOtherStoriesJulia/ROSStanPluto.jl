...
begin
    Random.seed!(123)
    data = (n=2, y=[-1, 1])
    m9_2s = SampleModel("m9_2s", stan9_2)
...
begin
	...
	success(rc9_3s) && model_summary(m9_3s)
end
...
ms9_3s = model_summary(m9_3s, [:alpha, :sigma])
...
begin
	...
	success(rc9_4s) && model_summary(m9_4s)
end
...
begin
	...
	success(rc9_5s) && model_summary(m9_5s)
end
...
begin
	...
	success(rc8_3s) && model_summary(m8_3s)
end
