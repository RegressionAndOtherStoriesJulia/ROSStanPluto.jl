...
# ╔═╡ 5ca5879e-0c70-4dac-8c0e-b9c5c825ce8f
md"
!!! note

This MWE works in the Julia-1.7-RC3 REPL. In Pluto it requires:

`import Pluto; Pluto.run(workspace_use_distributed=false)`"


# ╔═╡ 6c2043f4-dcbd-4535-a5ae-61c109519879
electric = CSV.read(joinpath(@__DIR__, "electric.csv"), DataFrame)
...
let
	...
	for j in 0:1
		for i in 1:4
			...
			vline!(f, [mean(el)]; color=:darkred, linewidth=3)
			append!(figs, [f])
		end
	end
	plot(figs...; layout=(2,4), plot_title="Fig-1.3", titlefontsize=9)
end
